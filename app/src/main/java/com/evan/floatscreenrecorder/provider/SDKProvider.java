...
public class SDKProvider extends ContentProvider implements LifecycleObserver {
    ...
    public boolean onCreate() {
        ...
        ProcessLifecycleOwner.get().getLifecycle().addObserver(new DefaultLifecycleObserver() {
            ...
            public void onStart(@NonNull LifecycleOwner owner) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        m_context.startService(new Intent(m_context, FABService.class));
            ...
            public void onStop(@NonNull LifecycleOwner owner) {
                ...
                m_context.sendBroadcast(startIntent);

                // 部分手機鎖屏視同onDestroyed，需判斷狀態是否是鎖屏 //
                KeyguardManager mKeyguardManager = (KeyguardManager) m_context.getSystemService(Context.KEYGUARD_SERVICE);
                isScreenOff = mKeyguardManager.inKeyguardRestrictedInputMode();
            }
        });

        ((Application) m_context).registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            @Override
            ...
            public void onActivityDestroyed(Activity activity) {
                ...
                if (RecordingManager.getIsRecording()) {
                    EvanSDK.setLoopRecordingStatus(m_context, false, null);
                }
            }
        });
        return true;
    ...
    private void getNotificationPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationManager notificationManager = (NotificationManager) m_context.getSystemService(NOTIFICATION_SERVICE);
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            goToActivity(m_context, PermissionActivity.class, permissionStrings, NOTIFICATIONS);
        }
    }
